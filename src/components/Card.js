...
const Card = ({ i, title, description, link }) => {
  const content = (
    <div className="font-nunito py-6 bg-gray-300 bg-opacity-20 shadow-lg rounded-xl p-6 w-full transition-transform duration-200 ease-in-out transform hover:scale-105 hover:shadow-[0px_4px_15px_#fd9983]">
      {i && (
        <div className="mb-4">
